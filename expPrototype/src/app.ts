...
let carroModelo = new Carro("Toro", "Fiat", 4, "Preto", 170, 5);
...
// Criando os clones:
let cloneCarro1 = carroModelo.clone("Etios", "Toyota", 4, "Prata", 95, 5);
listaVeiculos.push(cloneCarro1);

let cloneCarro2 = carroModelo.clone("Picanto", "Kia", 4, "Preto", 85, 5);
